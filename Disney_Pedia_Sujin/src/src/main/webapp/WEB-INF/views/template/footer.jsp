		...
		<div class="css-1djzg97">
			<div class="css-7sb2y7-FooterLeft e19unuxw4">
				...
				<ul
					...
					<li
						class="css-18lsujb-StyledTermsAndPolicyList-StyledTermsAndPolicyList-StyledCSList e19unuxw12">디즈니
						플러스</li>
					<li
						class="css-1bz3wqq-StyledTermsAndPolicyList-StyledCSList e19unuxw12"><a
						href="https://www.disneyplus.com/home"
						class="css-gb6obi-StylelessHref-StyledMailLink e19unuxw18">https://www.disneyplus.com</a></li>
				</ul>
				<ul
					class="css-8niyb4-VisualUl-StyledTermsAndPolicy-StyledCoWork e19unuxw13">
					<li
						class="css-1kk9xna-StyledTermsAndPolicyList-StyledTermsAndPolicyList-StyledCoWorkList e19unuxw14">이용
						API</li>
					<li
						class="css-dbeq2k-StyledTermsAndPolicyList-StyledCoWorkList e19unuxw14"><a
						href="https://www.themoviedb.org/" target="_blank"
						class="css-8093ho-StylelessHref-StyledMailLink-StyledTextLink e19unuxw19">https://www.themoviedb.org/</a></li>
				</ul>
				<ul
